...
import com.pixelart.week4daily2.RecyclerViewAdapter
import com.pixelart.week4daily2.model.MyWeather
        ...
        RemoteHelper.getWeatherData().subscribeOn(Schedulers.io())
            ...
            .subscribe(object : SingleObserver<WeatherData> {
                override fun onSuccess(t: WeatherData) {
                    ...
                    Log.d(TAG, "precipitation: ${t.list[25].rain._3h}mm")
                        ...
                        for (j in 0 until t.list[i].weather.size) {
                            (weatherList as ArrayList<MyWeather>).add(
                                MyWeather(
                                    ...
                                    "Wind: ${String.format("%.2f", t.list[i].wind.speed)}m/s - ${String.format("%.2f", t.list[i].wind.deg)}°",
                    ...
                    adapter = RecyclerViewAdapter(weatherList, object : RecyclerViewAdapter.OnItemClickListener {
                   ...
                   /* Log.d(
                        TAG,
                        "City name: ${t.city.name} Temperature: ${String.format(
                            "%.2f",
